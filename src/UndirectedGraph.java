...
public class UndirectedGraph<Item> {
    private int numOfVertices;
    private int numOfEdges;

    // change to grid system don't need to store neighbors
    private Map<String, Vertex<Item>> vertices;

    public UndirectedGraph(Map<String, Vertex<Item>> vertexMap) {
        numOfEdges = 0;
        numOfVertices = 0;
        vertices = vertexMap;
    }
    ...
    public void addNeighbor(String source, String target, float cost) {
